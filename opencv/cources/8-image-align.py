...
dir = os.path.join(os.getcwd(), f"../../tmp/opencv/8")
if not os.path.exists(dir):
    os.mkdir(dir)

asset_zip_path = os.path.join(dir, f"opencv_bootcamp_assets_NB8.zip")
...
refFilename = os.path.join(dir,"form.jpg")
print("Reading reference image:", refFilename)
im1 = cv2.imread(refFilename, cv2.IMREAD_COLOR)
im1 = cv2.cvtColor(im1, cv2.COLOR_BGR2RGB)

# Read image to be aligned
imFilename = os.path.join(dir, "scanned-form.jpg")
