...
DIR = os.path.join(os.getcwd(), f"../../tmp/opencv/12")
path = lambda name: os.path.join(DIR, name)
URL = r"https://www.dropbox.com/s/efitgt363ada95a/opencv_bootcamp_assets_12.zip?dl=1"
ZIP = path(f"opencv_bootcamp_assets_12.zip")
...
net = cv2.dnn.readNetFromCaffe(path("deploy.prototxt"), path("res10_300x300_ssd_iter_140000_fp16.caffemodel"))
# Model parameters
in_width = 300
in_height = 300
mean = [104, 117, 123]
