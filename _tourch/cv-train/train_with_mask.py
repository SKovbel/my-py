...
image = read_image(path("PennFudanPed/PNGImages/FudanPed00046.png"))
mask = read_image(path("PennFudanPed/PedMasks/FudanPed00046_mask.png"))
...
model = cv_model.get_model_instance_segmentation(num_classes)
