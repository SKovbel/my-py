...
save_dir = os.path.join(os.path.dirname(__file__), '../../../tmp/weather/checkpoint')
path_checkpoint =  os.path.join(save_dir, "model_checkpoint.h5")
...
def show_raw_visualization(data):
    ...
    fig, axes = plt.subplots(nrows=7, ncols=2, figsize=(15, 10), dpi=80, facecolor="w", edgecolor="k")
...
if os.path.exists(path_checkpoint):
    ...
    checkpoint_manager = tf.train.CheckpointManager(checkpoint, save_dir, max_to_keep=3)
